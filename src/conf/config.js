...
// scoring for consequence types

const consequenceTypesComparator = (type1, type2) => {
    ...
    let idx1 = consequenceTypes.indexOf(type1);
    idx1 = idx1 >= 0 ? idx1 : consequenceTypes.length;
    let idx2 = consequenceTypes.indexOf(type2);
    idx2 = idx2 >= 0 ? idx2 : consequenceTypes.length;
    return idx1 - idx2;
}