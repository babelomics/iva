    ...
    es: {
        clinical: {
            report: {
                ...
                interpretationText_prenatal_dominant: 'El riesgo de trasmitir esta mutación a la descendencia, y de que por tanto tengan un riesgo incrementado a desarrollar la enfermedad, es del 50% para cada hijo. El diagnóstico prenatal es posible en esta familia.',
                interpretationText_prenatal_recessive_1: 'El riesgo de tener hijos o hijas afectos de %%paciente%% depende del estado de portador de la pareja.',
                interpretationText_prenatal_recessive_2: 'El riesgo de tener hijos o hijas afectos de %%paciente%% es de X¼ para cada embarazo. El diagnóstico prenatal es posible en esta familia.',
                interpretationText_prenatal_xlinked_1: 'El riesgo de transmitir esta mutación a la descendencia es del 50% para cada hijo, siendo por tanto el riesgo de tener hijos afectos o hijas portadoras del 50% en cada embarazo. El diagnóstico prenatal es posible en esta familia.',
                interpretationText_prenatal_xlinked_2: 'La ausencia en la paciente de la mutación (mutación) del gen (gen) observada en su hijo, paciente índex de la familia, indica que se trata de una mutación de novo. No obstante no podemos descartar la presencia de mosaicismo germinal en la paciente. Dichos mosaicismos no pueden ser analizados y su existencia aumentaría el riesgo de recurrencia de la enfermedad dentro del núcleo familiar. El diagnóstico prenatal es posible en esta familia.',
            }
        }
    }
}
